...
class RewardMonitor:
    def __init__(self) -> None:
        ...
        self._foot_angle_reward_list: list[float] = []
    ...
    def add_foot_angle_reward(self, reward: float) -> None:
        self._foot_angle_reward_list.append(reward)
    ...
    def save_foot_angle_reward_plot(self, save_path: str) -> None:
        Utils.save_plot(
            xdata=list(range(len(self._foot_angle_reward_list))),
            ydata=self._foot_angle_reward_list,
            title="Foot Angle Reward",
            xlabel="Epoch",
            ylabel="Foot Angle Reward",
            save_path=save_path,
            plot_type="line"
        )
    ...
    def save_combined_reward_plot(self, save_path: str) -> None:
        ...
        length = min(
            ...
            len(self._foot_angle_reward_list),
        ...
        y_dict = {
            ...
            "Delta Foot Angle Reward": moving_average(self._foot_angle_reward_list[:length]),
